...
To study specific cases for triangle closing, we revert to treating the graph as directed. Note that the same triangle closing case on an undirected graph can turn into four possible types of cases for a directed graph, as shown below: 
\begin{figure}[H]
    \centering
