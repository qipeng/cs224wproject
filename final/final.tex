...
\begin{figure*}
\centering{
\includegraphics[width=0.33\textwidth]{./graphs/p1-1}\includegraphics[width=0.33\textwidth]{./graphs/p1-2}\includegraphics[width=0.33\textwidth]{./graphs/p2-1}
}
...
\begin{figure}[H]
\centering{
\includegraphics[width=0.5\linewidth]{./graphs/p2-2}
}
